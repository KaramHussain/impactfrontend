<template>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <!-- muskaan start -->
      <!-- <table border=2 class="w-100 claim-table" v-if="Object.keys(patientDetails).length > 0"> -->
...
export default {
  ...
  async mounted() {
    let patientDetailsObject =  localStorage.getItem('patientDetails') == undefined ? undefined : JSON.parse(localStorage.getItem('patientDetails'))
    if(patientDetailsObject != undefined){
