    ...
    <div class="col-12">
      <div class="card">
          <div class="card-header">
              <h4 class="card-title">Denial Trends</h4>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters('graphs', {
      ...
      denialTrendsData : 'denialTrendsData'
    }),
  ...
  methods: {
    ...
    chartData(data = []) {
      ...
      return {
        ...
        datasets: [{
            ...
            label: "Avoidable",
            data: data.avoidable_denied_amount,
            backgroundColor: "#fcc724",
            hoverBackgroundColor: "#fcc724",
            borderColor: "transparent",
            barThickness : 100
        }]
      }
    ...
    reload() {
      this.destroyChart()
      this.load({load:false, range:this.range, graph_name:'denialTrendsData'})
    },
