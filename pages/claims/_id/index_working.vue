                ...
                <div class="card-content claim">
                  ...
                  <div class="card-body" v-else>
                    ...
                    <table
                      ...
                      border="2"
                      v-if="ediValidationButtonClicked"
                    >
                      <!-- patient claims -->
                      <tr>
                        <td
                  ...
                  <div class="buttons-group">
                    ...
                    <button
                      ...
                      class="btn btn-primary float-right clearfix ml-1 mb-2 mr-1"
                    ...
                    <!-- :disabled="!assigned ||  loading" -->
                    <button
                      class="btn btn-success float-right clearfix ml-1 mb-2 mr-1"
                    ...
                    <!-- EDI validations -->
                    <button
                      class="btn btn-info float-right clearfix ml-1 mb-2 mr-1"
