      ...
      <div class="content-overlay"></div>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <h3 class="content-header-title mb-0 d-inline-block mr-2">Claims List</h3>
            ...
            <div class="col-md-6">
              ...
              <div class="dropdown d-inline-block" style="width:65%">
                ...
                <div class="dropdown-menu" aria-labelledby="responseLink">
                  ...
                  <a class="dropdown-item" href="javascript:void(0)" v-for="{key, value} in claimHeaders" :key="value">
                    <label :for="value">
                      <input type="checkbox" class="claimHeader" :id="value+'_claimHeader'" :value="value" name="claimHeader"> 
                      {{key}}
                    </label>
                  </a>
              ...
              <button class="btn btn-primary btn-sm d-inline-block" style="width:32%" @click="createGraph">Collectors Performance</button>
          ...
          <claimlist-cards :stats="stats" class="my-2 mx-0" @clicked="filterClaims" />
          ...
          <div class="content-header row">
              ...
              <div class="col-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4 col-12">
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="statusLink">
                          ...
                          <a class="dropdown-item" href="javascript:void(0)" v-for="{key, value} in statuses" :key="value">
                            <label :for="value">
                  
                              <input :checked="shouldBeChecked(value, 'status')" type="checkbox" :id="value" :value="value" name="status" @change="addFilter($event, 'status')"> 
                              {{key}}
                            </label>
                          </a>
                    ...
                    <div class="col-md-4 col-12">
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="responseLink">
                          ...
                          <a class="dropdown-item" href="javascript:void(0)" v-for="{key, value} in claimStatuses" :key="value">
                            <label :for="value">
                              <input :checked="shouldBeChecked(value, 'eob_response')" type="checkbox" :id="value" :value="value" name="eobResponse" @change="addFilter($event, 'eob_response')"> 
                              {{key}}
                            </label>
                          </a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="responseLink">
                          ...
                          <a class="dropdown-item" href="javascript:void(0)" v-for="payer in payers" :key="payer['PAYER ID']">
                            <label :for="payer['PAYER ID']">
                              <input :checked="shouldBeChecked(payer['PAYER ID'], 'payer')" type="checkbox" :id="payer['PAYER ID']" :value="payer['PAYER ID']" name="payer" @change="addFilter($event, 'payer')"> 
                              {{payer['PAYER NAME']}}
                            </label>
                          </a>
                    ...
                    <div class="col-md-4 col-12 mt-2">
                      ...
                      <select id="status" class="form-control form-control-sm" v-model="filters.sort_by">
                        <option :value="value" v-for="{key, value} in sorts" :key="value">
                          {{key}}
                        </option> 
                      </select>
                    </div>
                    ...
                    <div class="col-md-4 col-12 mt-2">
                      ...
                      <select id="orderBy" class="form-control form-control-sm" v-model="filters.order_by">
                    ...
                    <div class="filter col-md-2 col-12 mt-2">
                      ...
                      <button class="btn btn-primary btn-sm px-2" @click.prevent="filter">Filter</button>
                    </div>

                    <div class="col-md-2 col-12 mt-2">
                      <label style="visibility:hidden">Reset</label><br>
                      <button class="btn btn-secondary btn-sm px-2" @click.prevent="reset">Reset</button>
                    </div>
              ...
              <div class="content-header-right col-md-6 col-12">
                ...
                <search-filter @input="searchTerm=$event" placeholder="Search in claims" />
                                ...
                                <thead>
                                    <tr>
                                      ...
                                      <th>
                                        ...
                                        <span class="sortable" @click="sortBy('claim_status')">
                                          EOB Response
                                      ...
                                      <th>
                                          <span class="sortable" @click="sortBy('total_claim_charges')">
                                          Claim charges
                                      ...
                                      <th>
                                        ...
                                        <span class="sortable" @click="sortBy('date_of_service')">
                                          DOS
                                      ...
                                      <th>
                                        <span class="sortable" @click="sortBy('payer_name')">
                                        Payer
                                          <div class="arrow"
                                          :class="{'arrow--asc':sort.order == 'asc',
                                            'arrow--desc':sort.order == 'desc'}"
                                      ...
                                      <th>
                                        ...
                                        <span class="sortable" @click="sortBy('provider.name')">
                                          Person working
...
export default {
  ...
  computed: {
    ...
    validatedClaimHeaders() {
      let headers = Array.from(document.querySelectorAll('.claimHeader:checked'))
  ...
  methods: {
    ...
    createGraph() {
      this.$router.push({ name: 'claims-reports', query: {graphType: this.validatedClaimHeaders} })
    },

    shouldBeChecked(value, type) {
      if((value == 'assigned' || value == 'to_be_reviewed') && (this.$route.query.status && (this.$route.query.status == 'unpaid_claims' || Array.from(this.$route.query.status.includes('unpaid_claims'))))) {
        return true
      }
    ...
    filterClaims({formattedTitle}) {
      ...
      let claimStatuses = this.claimStatuses.map(status => status.value.toLowerCase())
    ...
    async getClaims(page, filters = {}) {
      ...
      await this.$axios.post('provider/get-claims-with-collector', {
    ...
    remarkTypes(key) {
      ...
      let low_fruit = 0, avoidable = 0, compliance = 0
